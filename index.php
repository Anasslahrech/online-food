...
session_start(); // start session until logout/browser closed
?>
<head>
    <meta charset="utf-8">
    ...
    <section class="hero bg-image" data-image-src="images/img/main.jpeg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                ...
                <h5 class="font-white space-xs">Trouver les Restaurants, Specials, et les coupons Gratuit</h5>
                <div class="banner-form">
                    <form class="form-inline" method="GET" action="restaurants.php">
                        <div class="form-group">
                            <label class="sr-only" for="searchInput">Je voudrais manger....</label>
                            <input type="text" class="form-control form-control-lg" id="searchInput" name="search" placeholder="Je voudrais manger....">
                        </div>
                        <button type="submit" class="btn theme-btn btn-lg">Rechercher</button>
                    </form>
                </div>
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span>1. </span>Choisir un Restaurant</h4>
                    </div>
                        <!-- end:Step -->
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Choisissez un plat savoureux</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Sur place ou livraison </h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    ...
                    <p class="lead">Le moyen le plus simple d'accéder à votre plat préféré</p>
                </div>
                <div class="row">
				<?php
    ...
    echo '<div class="col-xs-12 col-sm-6 col-md-4 food-item">
              <div class="food-item-wrap">
                  ...
                  <div class="content">
                      ...
                      <div class="price-btn-block"> <span class="price"> '.$r['price'].' MAD</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Commander maintenant</a> </div>
                  </div>
              </div>
          </div>';
}
        ...
        <section class="how-it-works">
            <div class="container">
                <div class="text-xs-center">
                    <h2>Commander facilement en 3 étapes</h2>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>Nous vous proposons des menus de plus de 345 restaurants de livraison en ligne.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Choisissez un plat savoureux</h3>
                                <p>Nous avons ce qu'il vous faut avec les menus de plus de 345 restaurants livrant en ligne..</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Sur place ou la livraison</h3>
                                <p>Faites-vous livrer votre commande ! Et bon appétit ! Payez en ligne lors du retrait ou de la livraison</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Payer par Cash ou à la livraison.</p>
                    </div>
                </div>
            </div>
        </section>
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	...
																	<div class="bottom-part">
																		<div class="cost"><i class="fa fa-check"></i> Min MAD 10,00</div>
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            ...
                            <div class="col-xs-12 col-sm-7 left-text">
                                ...
                                <p>
                                Maintenant, vous pouvez faire venir de la nourriture où que vous soyez grâce à l'application de livraison et de plats à emporter gratuite et facile à utiliser..</p>
                                <div class="social-btns">
                                    <a href="#" class="app-btn apple-button clearfix">
                                        <div class="pull-left"><i class="fa fa-apple"></i> </div>
                                        <div class="pull-right"> <span class="text">Disponible sur </span> <span class="text-2">App Store</span> </div>
                                    </a>
                                    <a href="#" class="app-btn android-button clearfix">
                                        <div class="pull-left"><i class="fa fa-android"></i> </div>
                                        <div class="pull-right"> <span class="text">Disponible sur </span> <span class="text-2">Play store</span> </div>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            ...
                            <h5>Phone: 06-02-74-77-60 <a href="#"></a></h5> </div>
